  ...
  <div id="RemainTasks">
    ...
    <div class="cont">
      ...
      <div class="second common">
        ...
        <!-- 开始任务 -->
        <el-button type="success" @click="startTask" round>开始任务</el-button>
      </div>
      <!-- 开发人员 -->
    ...
    mounted () {
      ...
      this.postRequest(remainTasksUrl)
        .then((res) => {
          ...
          this.IP = data.array.IP;
          this.develop1Name = data.array.develop1Name;
          this.develop2Name = data.array.develop2Name;
          this.testerName = data.array.testerName;
          this.developer1Avatar = data.array.developer1Avatar;
          this.developer2Avatar = data.array.developer2Avatar;
          this.priority = data.array.priority;
          this.status = data.array.status;
          this.question = data.array.question;
        })
        .catch((error) => {
          console.log(error);
        })
