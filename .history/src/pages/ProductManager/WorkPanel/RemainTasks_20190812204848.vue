      ...
      refleshRemainTask () {
        ...
        this.postRequest(remainTasksUrl)
          .then((res) => {
            ...
            this.IP = data.array[0].IP;
            this.develop1Name = data.array[0].develop1Name;
            this.develop2Name = data.array[0].develop2Name;
            this.testerName = data.array[0].testerName;
            // this.developer1Avatar = data.array[0].developer1Avatar;
            // this.developer2Avatar = data.array[0].developer2Avatar;
            // this.testerAvatar = data.array[0].testerAvatar;
            this.priority = data.array[0].priority;
            this.status = data.array[0].status;
            this.question = data.array[0].question;
            this.buttonMsg = data.array[0].buttonMsg;
          })
          .catch((error) => {
            console.log(error);
          })
