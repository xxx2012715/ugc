<template>
  <div id="WorkPanel">
    <div class="content">
      <!-- top展示栏 -->
      <work-welcome :totalTasksNumber="totalTasksNumber"></work-welcome>
      <!-- middle展示栏 -->
      <div class="remain">
        <!-- 待办任务 -->
        <remain-tasks
          @changeRemainTasksNumber="remainTasksNumberChangeHandle"
        ></remain-tasks>
        <!-- 提醒事项 -->
...
<script>
  ...
  export default {
    ...
    methods: {
      remainTasksNumberChangeHandle (num) {
        // console.log('num', num);
        this.totalTasksNumber = num;
      }
    }
  }
</script>
