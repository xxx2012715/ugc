<template>
  <div id="ForumHead">
    ...
    <div class="cont">
      ...
      <div class="question">
        <!-- 表单 -->
        <el-form label-width="80px" id="form" label-position="left">
          <!-- 问题标题 -->
      ...
      <el-card class="selfInfo">
        ...
        <div class="userInfo">
          ...
          <span class="user">苏宸</span>
          <span class="user">研发经理</span>
        </div>
        <div class="info">
...
<script>
  export default {
    ...
    data () {
      return {
        quesAvatar: 'static/imgs/ziwei.jpg',
        form: {
          title: '',
          description: '',
          link: '',
    ...
    mounted() {
      console.log(localStorage.avatarUrl)
    },
    methods: {
      onSubmit () {
        console.log('提交')
