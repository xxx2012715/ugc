      ...
      onSubmit (form) {
        ...
        this.$refs[form].validate((valid) => {
          if (valid) {
            alert('提交成功');
            // 提交后台\
            let url = `/questionCreate?question={{this.name}}&dept={{this.department}}&type={{this.type}}&description={{this.description}}&priority={{this.priority}}&pm=&dev={{this.developer}}&tester={{this.tester}}&connect={{this.linkQuestion}}`
