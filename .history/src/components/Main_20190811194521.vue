<template>
  <div id="WorkPanel">
    ...
    <el-dialog title="创建问题" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <!-- 问题名称 -->
        <el-form-item label="问题名称" :label-width="formLabelWidth" required>
          <el-input
            autofocus
            v-model="form.name"
            autocomplete="off"
        ...
        <!-- 问题描述 -->
        <el-form-item label="问题描述" :label-width="formLabelWidth" required>
          <el-input type="textarea" v-model="form.description"></el-input>
        </el-form-item>
        <!-- 优先级 -->
        <el-form-item label="优先级" :label-width="formLabelWidth" required>
        ...
        <!-- 附件--disabled -->
        <el-form-item label="附件" :label-width="formLabelWidth" required>
          <el-input disabled></el-input>
        </el-form-item>
        <!-- 开发人员 -->
        <el-form-item label="开发人员" :label-width="formLabelWidth" required>
          <el-input v-model="form.developer" autocomplete="off"></el-input>
        </el-form-item>
        <!-- 测试人员 -->
        <el-form-item label="测试人员" :label-width="formLabelWidth" required>
          <el-input v-model="form.tester" autocomplete="off"></el-input>
        </el-form-item>
        <!-- 链接问题 -->
        <el-form-item label="链接问题" :label-width="formLabelWidth" required>
